...
(function (App) {
    ...
    (function (AxiosProvider) {
        ...
        AxiosProvider.ComprasEliminar = function (id) { return ServiceApi.delete("api/Compras/" + id).then(function (_a) {
            var data = _a.data;
            return data;
        }); };
        AxiosProvider.ComprasGuardar = function (entity) { return ServiceApi.post("api/Compras", entity).then(function (_a) {
            var data = _a.data;
            return data;
        }); };
        AxiosProvider.ComprasActualizar = function (entity) { return ServiceApi.put("api/Compras", entity).then(function (_a) {
            var data = _a.data;
            return data;
        }); };
